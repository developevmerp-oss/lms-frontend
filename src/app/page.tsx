...
import { JordiStudentGallery } from "@/components/landing/JordiStudentGallery";
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-orange-500 selection:text-slate-950 relative font-sans">
      ...
      {/* ─── SECTION 12: STUDENT TRANSFORMATION & WORKS HUB ─── */}
      <section className="py-20 px-6 overflow-hidden relative border-y border-slate-800/80 bg-slate-950/60 z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Interactive Jordi Garreta Inspired Works Hub (Gallery Grid vs List Switcher) */}
          <JordiStudentGallery artworks={[...ARTWORKS_ROW_1, ...ARTWORKS_ROW_2]} />
        </div>
      </section>
