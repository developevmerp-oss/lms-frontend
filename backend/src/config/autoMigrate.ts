...
export const runAutoMigrations = async (sequelize: Sequelize) => {
  ...
  const migrationQueries = [
    ...
    // --- USERS TABLE SOFT DELETE & PASSWORD RESET ---
    `ALTER TABLE "Users" ADD COLUMN IF NOT EXISTS "deletedAt" TIMESTAMP WITH TIME ZONE;`,
    `ALTER TABLE "Users" ADD COLUMN IF NOT EXISTS "resetPasswordOtp" VARCHAR(10);`,
    ...
    `ALTER TABLE "Courses" ADD COLUMN IF NOT EXISTS "price" VARCHAR(255);`,
    `ALTER TABLE "Courses" ALTER COLUMN "levelCode" DROP NOT NULL;`,
    `ALTER TABLE "PaymentTransactions" ADD COLUMN IF NOT EXISTS "courseId" UUID;`,
